...
|---|---|---|---|---|---|
| `healthy`   | `ink05` (subtle rest wash — same fill as `DsButton.secondary`) | `ink20` (`Border.Color.subtle` — softened further from ink40 → ink20 Luis 2026-05-27; attention/urgent borders stay signal — severity untouched) | `ink` | `ink` | 1pt (`Border.Width.normal`) |
